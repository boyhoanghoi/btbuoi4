...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Nhap so giao dich đat: ");
        soGiaoDichDat = scanner.nextInt();
        System.out.print("Nhap so giao dich nha: ");
        soGiaoDichNha = scanner.nextInt();
         
        System.out.println("Nhap thong tin giao dich đat:");
        for (int i = 0; i < soGiaoDichDat; i++) {
            System.out.println("Nhap thong tin giao dich đat thu " + (i + 1) + ":");
        ...
        System.out.println("Trung binh thsnh tien cua giao dich dat = " + trungBinhThanhTien);
        ...
        System.out.println("Cac giao dich nha cua thang 9 năm 2013: ");
        for (int i = 0; i < arrGiaoDichNha.size(); i++) {
